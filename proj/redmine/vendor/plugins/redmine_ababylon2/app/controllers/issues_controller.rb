...
class IssuesController < ApplicationController
  ...
  # changed from redmine_issues_group
  def retrieve_query_with_babylon2groupby
    retrieve_query_without_babylon2groupby
    if params[:query_id].blank?
      @query.group_by = params[:group_by] if params[:group_by]
    end
    #lsx#  add TableOptions
  ...
  alias_method_chain :retrieve_query, :babylon2groupby
